...
public class Weapon : MonoBehaviour
{
	...
	public enum Type { Melee, Range, Range_S };
	public Type type;
	public int damage;
	public float rate;
	...
	public float[,,] level_stat ={
		{{3,2,0,0 }, {1,1,1,1 }, {1,0.5f,1,1 }, { 1,1,1,1} },
		{{5,2,0,0 }, {2,1,1.2f,1 }, {1,0.4f,1,1.2f },{1,1,1,1 } },
		{{7,2,0,0 }, {3,0.9f,1,1.1f }, {1,0.3f,1,1.2f },{1,1,1,1 } },
		{{8,1.7f,0,0 }, {4,0.9f,1.2f,1 }, {2,0.3f,1,1 },{ 1,1,1,1} },
		{{13, 1.7f, 0, 0}, {4, 0.8f, 1.2f, 1.2f}, {3,0.3f,1,1 }, { 1, 1, 1, 1 }},
		{{13, 1.5f, 0, 0}, {4, 0.5f, 1, 1.2f}, {4, 0.3f, 1.2f, 1},{1,1,1,1 } },
		{{15, 1.5f, 0, 0}, {7, 0.5f, 1, 1}, {4, 0.1f, 1, 2}, { 1, 1, 1, 1 } },
	};
	...
	public void Use()
	{
		...
		else if (type == Type.Range_S)
		{
			StopCoroutine("Shot_S");
			StartCoroutine("Shot_S");
		}
	}
	IEnumerator Swing()
	{
	...
	IEnumerator Shot_S()
	{
		...
		for (int i = 0; i < 5; i++)
		{
			Quaternion newRotation = Quaternion.Euler(0f, newYRotation - 135f + i * 22.5f, 0f);
			newBullet[i] = Instantiate(bullet, firePos.position, newRotation);
			newBullet[i].GetComponent<bulletManager>().initBullet(damage, 1, 1, true);
			newBullet[i].transform.localScale *= 0.2f;
			newBullet[i].SetActive(true);
		}
